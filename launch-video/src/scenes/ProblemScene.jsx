...
export const ProblemScene = () => {
  ...
  const items = ["Architecture", "Release rules", "Prior failures", "Human decisions"];
  return <Scene><Brand />
    <div style={{ position: "absolute", left: 110, top: 260, width: 1080 }}>
      ...
      <Reveal from={36}><p style={{ margin: 0, width: 850, color: palette.muted, fontSize: 38, lineHeight: 1.4 }}>Context compaction should not erase the work that made the project understandable.</p></Reveal>
    </div>
