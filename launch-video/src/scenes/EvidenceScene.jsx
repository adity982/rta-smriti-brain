...
export const EvidenceScene = () => {
  ...
  return <Scene><Brand />
    <div style={{ position: "absolute", left: 110, top: 250, width: 780 }}><Reveal><Eyebrow>Bitemporal truth + Pramana</Eyebrow></Reveal><Reveal from={14}><h1 style={{ margin: "18px 0 24px", fontSize: 96, lineHeight: .98 }}>Truth with time.<br />Evidence with weight.</h1></Reveal><Reveal from={34}><p style={{ margin: 0, color: palette.muted, fontSize: 33, lineHeight: 1.45 }}>Recorded time and valid time stay distinct. Captured text remains unverified until evidence promotes it.</p></Reveal></div>
