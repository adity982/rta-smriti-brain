...
export const CaptureScene = () => {
  ...
  return <Scene><Brand />
    <div style={{ position: "absolute", left: 100, top: 190, zIndex: 2, width: 720 }}>
      <Reveal><Eyebrow>v0.9 · Universal Capture</Eyebrow></Reveal>
    ...
    <Img src={staticFile("capture.png")} style={{ position: "absolute", right: -120, bottom: -10, width: 1250, border: `1px solid ${palette.line}`, borderRadius: 10, boxShadow: "0 40px 100px #000", rotate: "-1deg", scale: interpolate(frame, [0, 45], [.93, 1], { extrapolateLeft: "clamp", extrapolateRight: "clamp", easing: Easing.bezier(.16,1,.3,1) }), opacity: interpolate(frame, [0, 22], [0, 1], { extrapolateRight: "clamp" }) }} />
  </Scene>;
};