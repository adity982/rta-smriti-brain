...
export const ContextScene = () => {
  ...
  return <Scene><Brand />
    <div style={{ position: "absolute", left: 105, top: 205, width: 760, zIndex: 2 }}><Reveal><Eyebrow>v0.9 context compiler</Eyebrow></Reveal><Reveal from={14}><h1 style={{ margin: "18px 0 30px", fontSize: 82, lineHeight: 1 }}>Only governed context.<br />For this task.</h1></Reveal>
