...
BASELINE_REF = "v0.6.0-alpha"
BASELINE_COMMIT = "6c086f5e421f8ec5506e7ee6e6cb0296ca43fed3"
...
def main() -> int:
    with tempfile.TemporaryDirectory(prefix="rta-smriti-wheel-build-") as tmp:
        ...
        if baseline_version == expected_version:
            raise AssertionError("upgrade smoke baseline and candidate versions are identical")
